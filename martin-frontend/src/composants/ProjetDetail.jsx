...
export default function ProjetDetail() {
  ...
  if (!projet) return <p className="text-gray-400 px-6 py-8">Projet introuvable</p>

  return (
    <div className="min-h-screen px-6 lg:px-12 py-16 lg:py-24 pt-32">
      <p className="text-gray-400 text-xs tracking-[3px] uppercase mb-10 lg:mb-16">{projet.categorie}</p>
      <div className="flex flex-col lg:flex-row lg:justify-between lg:gap-24">
        <div className="lg:max-w-xl">
          ...
          {projet.difficulte && (
            <p className="text-gray-400 text-sm italic mb-8 lg:mb-10">
        ...
        <div className="flex-shrink-0 flex items-center justify-center mt-10 lg:mt-0" style={{ width: '100%', maxWidth: '550px', height: '600px' }}>
          <img
            src={projet.image}
            alt={projet.titre}
