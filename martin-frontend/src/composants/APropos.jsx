export default function APropos() {
  return (
    <div className="flex justify-between items-start px-12 py-24" style={{borderTop: '1px solid #1a1a1a'}}>
      <div style={{maxWidth: '600px'}}>
        <p className="text-gray-600 text-xs tracking-[3px] uppercase mb-8">À propos</p>
        <h2 className="text-4xl font-light text-white mb-10">Martin Lièvre</h2>
      ...
      <div className="flex-shrink-0" style={{width: '380px', height: '500px'}}>
